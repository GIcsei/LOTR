...
public class Hobbit_character extends Character {
    private int modifier;
    private final static int character_id=1;
    public Hobbit_character(String name, int strength, int agility, int health, int constitution, int intelligence, int intuition, int charisma) {
