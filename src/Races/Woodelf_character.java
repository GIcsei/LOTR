...
public class Woodelf_character extends Character {
    private int modifier;
    private final static int character_id=7;
    public Woodelf_character(String name, int strength, int agility, int health, int constitution, int intelligence, int intuition, int charisma) {
