...
public class Half_elf_character extends Character {
    private int modifier;
    private final static int character_id=6;
    public Half_elf_character(String name, int strength, int agility, int health, int constitution, int intelligence, int intuition, int charisma) {
