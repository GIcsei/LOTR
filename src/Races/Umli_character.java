...
public class Umli_character extends Character {
    private int modifier;
    private final static int character_id=2;
    public Umli_character(String name, int strength, int agility, int health, int constitution, int intelligence, int intuition, int charisma) {
